...
2. My TO-DO: fatal code is overlaping with shutdown code, won't be able to restart component after fatal. Should seperate shutdown and fatal, shutdown code is now x98, waiting for update.
