...
public class BAMSTester {
	...
	private BAMSCommunicator serverCommunicator = new BAMSCommunicator();
	...
	public boolean doBAMSUpdateBalance(String accNumber, double amount, Session currentSession) {
		...
		if (amount > 0) // deposit
			resultAmount = Math.round(
					serverCommunicator.deposit(currentSession.getCardNo(), accNumber, currentSession.getCred(), (int) amount)); // round down
